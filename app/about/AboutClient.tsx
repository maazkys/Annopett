  ...
  return (
    <>
      ...
      <motion.section className="bg-white" style={{ padding: sectionPadding }}>
        <motion.div
          className="relative h-[calc(100vh-1.5rem)] min-h-[640px] overflow-hidden flex flex-col items-center justify-center text-center z-0"
          style={{ borderRadius }}
        >
      ...
      <section className="bg-[#fafaf8] px-6 lg:px-[8vw] py-28 relative">
        <div className="grid lg:grid-cols-[36%_1fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-12">
            <FadeIn delay={0.1}>
              <div className="w-full aspect-[16/10] rounded-[28px] overflow-hidden bg-black/5 mb-10">
                <img
              ...
              <div className="space-y-6 text-lg sm:text-xl font-light text-dark/70 font-sans leading-relaxed max-w-2xl">
                <p>
        ...
        <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
          {values.map((v, i) => (
            <FadeIn key={v.t} delay={i * 0.08}>
              <div className="group relative rounded-[32px] overflow-hidden h-[400px] bg-black/5 border border-black/5">
                <img
                  src={img(v.i)}
                  alt={v.t}
                  loading="lazy"
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#120d07]/90 via-[#120d07]/20 to-transparent transition-opacity duration-500 group-hover:opacity-100" />
                <div className="absolute bottom-0 left-0 p-10 w-full translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                  <h3
